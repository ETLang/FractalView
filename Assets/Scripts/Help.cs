...
public static class Help
{
    ...
    public static bool Any(bool2 b2)
    {
        return b2.x || b2.y;
    }

    public static bool All(bool2 b2)
    {
        return b2.x && b2.y;
    }

    public static bool Any(bool3 b3)
    {
        return b3.x || b3.y || b3.z;
    }

    public static bool All(bool3 b3)
    {
        return b3.x && b3.y && b3.z;
    }

    public static bool Any(bool4 b4)
    {
        return b4.x || b4.y || b4.z || b4.w;
    }

    public static bool All(bool4 b4)
    {
        return b4.x && b4.y && b4.z && b4.w;
    }
